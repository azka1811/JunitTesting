public class ArrayList {
	...
	static int numofElements; //number of elements in the array.
	static int addPointer; //pointer points to the position where new number will be added.
	...
	//function to access elements at a given position.
	 static public int getElement(int index){
		return array[index];
	}

	//funciton to change the value of the element at the given position
	static public void setValue(int value, int index){
		array[index]=value;
	}
	
	//function to add element in the array.
	static public  void addElement(int number){
	...
	static public void removeElement(int index){
		if(addPointer==0){
